...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/org/camunda/support/SUPPORT_15507/ProcessTest.java) in your IDE or using:
...
```bash
java -jar target/SUPPORT-15507.jar
```
